...
def test_courses_endpoint_returns_enrolled_courses(client: TestClient, db_engine: Engine) -> None:
...
def test_unrelated_students_courses_are_not_returned(client: TestClient, db_engine: Engine) -> None:
    ...
    response = client.get(f"/students/{student_a}/courses")
...
def test_courses_are_returned_in_deterministic_order(
    ...
    first = client.get(f"/students/{student_id}/courses").json()
    second = client.get(f"/students/{student_id}/courses").json()
