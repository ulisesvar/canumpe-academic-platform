...
-- academic: only the three tables this pipeline actually merges into —
-- not the whole schema, and never DELETE (canonical records are never
-- physically deleted by this pipeline).
